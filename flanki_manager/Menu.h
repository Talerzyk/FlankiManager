...
public:
	...
	int Display(const std::vector<std::string> &menu, const std::string &message); //Displays menu and all options and allows to play game. Message is displayed on the top of the menu
	int GetKeyMenu();
